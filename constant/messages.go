	...
	CommunityMessages = map[string][]message.Template{
		...
		"bú,pú": {
			...
			},
			{
				...
				Emoji:    Nwng1,
				HasRef:   true,
				Url:      "https://cdn.discordapp.com/attachments/1048640658795155476/1373503158373978183/image.png?ex=6833e07f&is=68328eff&hm=38ee13f5c6d7e7a7195de279ac7b944d5d3d747f89d5dede3738ec3b50a5e625&",
				TagUsers: []string{FonChanID},
			},
			{
				Message:  "Kêu đĩ đi",
				Emoji:    Threesome,
				HasRef:   true,
				Url:      "https://cdn.discordapp.com/attachments/1048640658795155476/1374292233926479934/image.png?ex=68341c61&is=6832cae1&hm=4bdad9592548602497729409cb177709b1aa63d8a3b2b4bf86ed0f939b46408d&",
				TagUsers: []string{PiChanID},
			},
			{
				Message: "Vui lòng không chen hàng",
				Emoji:   ChichDien,
				HasRef:  true,
				Url:     "https://cdn.discordapp.com/attachments/1048640658795155476/1374308455170572358/image.png?ex=68342b7d&is=6832d9fd&hm=1022a3aeb444d1a3e265c0bf3758795c1cd1acda25e36512c4b95a0489e50729&",
			},
		},
		"địt": {
			{
			...
			{
				Message:  "Bún real đến đeyyyyyyyyyyyyy",
				Emoji:    Nwng1,
				Url:      "https://media.discordapp.net/attachments/1048640658795155476/1364437991484817521/20250423_100908.jpg?ex=680afce7&is=6809ab67&hm=6082a61711a7591077af5a6919914872698c9c8b1387b6a53b1ea50eb237486d&=&format=webp&width=2980&height=726",
				TagUsers: []string{DucToID},
			},
		},
		"nợ": {
			{
